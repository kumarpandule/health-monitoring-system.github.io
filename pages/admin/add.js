...
export const FormInput = (props) => {
  ...
  return (
    <div>
        <label
          className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">{label}<span className="text-red-500">*</span>
        </label>
...
export const FormDropdown = (props) =>{
  ...
  return (
      <div>
      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-state">{label}<span className="text-red-500">*</span>
      </label>
